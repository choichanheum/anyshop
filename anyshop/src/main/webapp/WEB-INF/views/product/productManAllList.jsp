...
<%-- <c:forEach items="${productList}" var="productList">
 <h2>여기
	<img src="resources/product/${productList.product_img}">
</h2>
...
<div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">${productList.product_kinds}</li>
        </ol>
      </div>
...
<c:forEach items="${productList}" var="productList">   
	<div class="aa-product-catg-body">
	              <ul class="aa-product-catg">
	                <li>
	                  <figure>
	                    <a class="aa-product-img" href="#"><img src="resources/product/${productList.product_img}" alt="polo shirt img"></a>
	                    <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
	                    <figcaption>
	                      <h4 class="aa-product-title"><a href="#">${productList.product_name}</a></h4>
	                      <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>${productList.product_price}</del></span>
